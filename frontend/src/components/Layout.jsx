        ...
        <>
          ...
          <NavGroup label="Ondersteuning">
            ...
            <NavRow
              ...
              icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="1.8" strokeLinecap="round"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>}
            />
          </NavGroup>
        </>
      )}
      ...
      {isAdmin && (
        <NavGroup label="Beheer">
          <NavRow
            ...
            color="#5856d6"
            label="Beheerportaal"
            icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="1.8" strokeLinecap="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>}
          />
        </NavGroup>
      )}
